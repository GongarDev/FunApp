 ...
 * @author melkart
 */
public class UsuariosEstandarTableModel extends AbstractTableModel {
    ...
    public void refreshTableModel(List<Usuario> listaUsuarios) {

        DateTimeFormatter formatterFecha = DateTimeFormatter.ofPattern("dd-MM-yyyy");

        List<Usuario> listaUsuariosTabla = listaUsuarios;
