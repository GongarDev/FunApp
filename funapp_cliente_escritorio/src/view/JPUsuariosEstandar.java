 ...
 * @author melkart
 */
public class JPUsuariosEstandar extends javax.swing.JPanel implements Protocolo {

    private VentanaPrincipal parent;
    private JPSesionAdmin vistaSesionAdmin;
    private List<Usuario> listaUsuarios;
    private UsuarioAdmin admin;
    private UsuariosEstandarTableModel usuariosTM;
    private String mensaje;
    private ListSelectionModel _lsm;
    
    public JPUsuariosEstandar(VentanaPrincipal parent, JPSesionAdmin vistaSesionAdmin) {
        this.usuariosTM = new UsuariosEstandarTableModel();
        initComponents();
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        jLMisEventos.setText("Usuarios Estándar");
    ...
    public void eliminarUsuario(int id_usuario) {
        ...
        try {
            Integer protocolo = ADMIN_ELIMINAR_USUARIO_ESTANDAR;
    ...
    public void llenarListUsuarios() {
        try {
            Integer protocolo = ADMIN_VER_USUARIOS_ESTANDAR;
            this.mensaje = this.parent.getGson().toJson(protocolo);
            this.parent.getSalida().writeUTF(this.mensaje);
            this.mensaje = (String) this.parent.getEntrada().readUTF();
        } catch (IOException ex) {
