 ...
 * @author melkart
 */
public class JPHistorial extends javax.swing.JPanel implements Protocolo{
    ...
    public JPHistorial(VentanaPrincipal parent, JPSesionAbierta vistaSesionAbierta) {
        initComponents();
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        jLMisEventos.setText("Historial");
        ...
        jLSinEventos.setText("No hay eventos pasados de fecha actual.");
    ...
    public void refrescarTablaTareas() {
        ...
        if (this.listaEventos.size() > 0) {
            ...
            this.jPTabla.setPreferredSize(new Dimension(660, 110 * this.listaEventos.size()));
            ...
            for (Evento e : this.listaEventos) {
                this.jPTabla.add(new JPEventoHistorial(e, this.parent, this), c);
                    c.gridy = count;
                    count++;
            }
        } else {
    ...
    public void actualizar() {
        ...
        vistaSesionAbierta.vistaHistorial();
    }

    public void llenarListEventos() {
        try {
            Integer protocolo = HISTORIAL_EVENTOS;
