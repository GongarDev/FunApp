...
public class Evento implements Serializable {
    ...
    public Evento(int id_evento, String nombre, Date fecha_publicacion, Date fecha_evento, LocalTime hora_inicio, LocalTime hora_fin, HashSet<Ubicacion> ubicaciones, String codigoQR, Tematica tematica, UsuarioResponsable usuario) {
